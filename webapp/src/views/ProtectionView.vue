...
/** Плитки фильтров в TMA: только @click часто молчит; отдельный touch-путь + исключение из глобального polyfill (двойной click). */
const PROTECTION_FILTER_TOUCH = new WeakMap()
let protectionFilterOpenedByTouchAt = 0

function onProtectionFilterTouchStart(ev) {
  const el = ev.currentTarget
  if (!(el instanceof HTMLElement)) return
  const t = ev.targetTouches?.[0] ?? ev.changedTouches?.[0]
  if (!t) return
  PROTECTION_FILTER_TOUCH.set(el, { x: t.clientX, y: t.clientY, t: Date.now() })
}

function onProtectionFilterTouchEnd(which, ev) {
  const el = ev.currentTarget
  if (!(el instanceof HTMLElement)) return
  const t = ev.changedTouches?.[0]
  const st = PROTECTION_FILTER_TOUCH.get(el)
  PROTECTION_FILTER_TOUCH.delete(el)
  if (!t || !st) return
  if (Date.now() - st.t > 900) return
  if (Math.abs(t.clientX - st.x) > 22 || Math.abs(t.clientY - st.y) > 22) return
  try {
  ...
  protectionFilterOpenedByTouchAt = Date.now()
  openProtectionFilterModal(which, 'filter-tile-touch')
}

function onProtectionFilterTileClick(which) {
  if (Date.now() - protectionFilterOpenedByTouchAt < 650) return
  openProtectionFilterModal(which, 'filter-tile-click')
}
...
<template>
  <div>
    ...
    <div v-else-if="chat?.rule" class="space-y-3.5">
      ...
      <div
        v-if="showChatPicker"
        style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-end justify-center bg-black/70 p-0 pb-[calc(5rem+env(safe-area-inset-bottom,0px))] md:items-end md:pb-6"
        ...
        <div class="space-y-3">
          ...
          >
            <button
              ...
              class="group relative flex cursor-pointer flex-col items-start rounded-xl border border-white/12 bg-gradient-to-br from-sky-500/15 to-indigo-600/10 p-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_6px_24px_-12px_rgba(0,0,0,0.45)] ring-1 ring-inset ring-white/[0.06] [-webkit-tap-highlight-color:transparent] transition hover:border-sky-400/40 hover:shadow-md active:scale-[0.99]"
              @touchstart.passive="onProtectionFilterTouchStart"
              @touchend.prevent.stop="onProtectionFilterTouchEnd('links', $event)"
            ...
            <button
              type="button"
              data-guard-no-tap-polyfill
              class="group relative flex cursor-pointer flex-col items-start rounded-xl border border-white/12 bg-gradient-to-br from-violet-500/15 to-fuchsia-600/10 p-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_6px_24px_-12px_rgba(0,0,0,0.45)] ring-1 ring-inset ring-white/[0.06] [-webkit-tap-highlight-color:transparent] transition hover:border-violet-400/40 hover:shadow-md active:scale-[0.99]"
              @touchstart.passive="onProtectionFilterTouchStart"
              @touchend.prevent.stop="onProtectionFilterTouchEnd('mentions', $event)"
            ...
            <button
              type="button"
              data-guard-no-tap-polyfill
              class="group relative flex cursor-pointer flex-col items-start rounded-xl border border-white/12 bg-gradient-to-br from-emerald-500/15 to-teal-600/10 p-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_6px_24px_-12px_rgba(0,0,0,0.45)] ring-1 ring-inset ring-white/[0.06] [-webkit-tap-highlight-color:transparent] transition hover:border-emerald-400/40 hover:shadow-md active:scale-[0.99]"
              @touchstart.passive="onProtectionFilterTouchStart"
              @touchend.prevent.stop="onProtectionFilterTouchEnd('buttons', $event)"
            ...
            <button
              type="button"
              data-guard-no-tap-polyfill
              class="group relative col-span-2 flex cursor-pointer flex-col items-start rounded-xl border border-white/12 bg-gradient-to-br from-fuchsia-500/15 to-indigo-600/10 p-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_6px_24px_-12px_rgba(0,0,0,0.45)] ring-1 ring-inset ring-white/[0.06] [-webkit-tap-highlight-color:transparent] transition hover:border-fuchsia-400/40 hover:shadow-md active:scale-[0.99]"
              @touchstart.passive="onProtectionFilterTouchStart"
              @touchend.prevent.stop="onProtectionFilterTouchEnd('channelPosts', $event)"
    ...
    <div
      ...
      style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-end justify-center bg-black/65 p-3 md:items-center"
    ...
    <div
      ...
      style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-end justify-center bg-black/60 p-3 md:items-center"
    ...
    <div
      ...
      style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-center justify-center bg-black/65 p-3"
    ...
    <div
      ...
      style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-end justify-center bg-black/70 p-3 backdrop-blur-[3px] md:items-center"
    ...
    <div
      ...
      style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-center justify-center bg-black/70 p-3 backdrop-blur-[3px]"
    ...
    <GuardTeleport>
      <div
        ...
        style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-end justify-center bg-black/75 px-3 pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] pt-[max(12px,calc(env(safe-area-inset-top,0px)+48px))] backdrop-blur-md md:items-center md:pb-6"
        role="dialog"
        aria-modal="true"
    ...
    <GuardTeleport>
      <div
        ...
        style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-center justify-center bg-black/75 p-4 backdrop-blur-[2px]"
        role="dialog"
        aria-modal="true"
    ...
    <GuardTeleport>
      <div
        ...
        style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-center justify-center bg-black/65 p-4 backdrop-blur-[2px]"
        role="dialog"
        aria-modal="true"
    ...
    <GuardTeleport>
      <div
        ...
        style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-start justify-center bg-black/60 p-4 md:items-center"
        role="dialog"
        aria-modal="true"
    ...
    <GuardTeleport>
      <div
        ...
        style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:95000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.65);padding:16px" class="flex items-center justify-center bg-black/70 p-4 backdrop-blur-[2px]"
        role="dialog"
        aria-modal="true"
