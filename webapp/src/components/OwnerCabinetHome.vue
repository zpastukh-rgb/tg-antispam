  ...
  <div class="space-y-3 font-display">
    ...
    <div class="grid grid-cols-2 gap-2.5">
      ...
      >
        ...
        >
          <span class="text-[10px]">👑</span> {{ t('owner_cabinet_home.premium_badge') }}
        </span>
        <p class="text-[13px] font-bold text-white">{{ t('owner_cabinet_home.protection_heading') }}</p>
      ...
      >
        ...
        <p class="text-[13px] font-bold text-white">{{ t('owner_cabinet_home.stats_heading') }}</p>
      ...
      <button
        ...
        @click="open('updates')"
      >
        <p class="text-[13px] font-bold text-white">{{ t('owner_cabinet_home.updates_heading') }}</p>
      ...
      <button
        ...
        @click="open('partner')"
      >
        <p class="text-[13px] font-bold text-white">{{ t('owner_cabinet_home.partner_heading') }}</p>
      ...
      >
        <p class="text-[13px] font-bold text-white">{{ t('owner_cabinet_home.broadcasts_heading') }}</p>
      ...
      <button
        ...
        @click="open('settings')"
      >
        <p class="text-[13px] font-bold text-white">{{ t('owner_cabinet_home.settings_heading') }}</p>
