...
# Политические темы / деятели / военная риторика (отдельный фильтр "Анти-политика").
DEFAULT_POLITICS_ROOTS = (
    "политик", "политика", "политический", "госдум", "дума", "депутат", "сенатор",
    "президент", "премьер", "министр", "правительств", "оппозици", "санкци",
    "выборы", "референдум", "митинг", "протест", "революци", "переворот",
    "войн", "военн", "сво", "всу", "нато", "оон", "генштаб", "мобилизац",
    "фронт", "обстрел", "бомб", "ракет", "дрон", "беспилот", "артобстрел",
    "террор", "теракт",
